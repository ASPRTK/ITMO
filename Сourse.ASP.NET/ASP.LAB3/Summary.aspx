<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="Lab3.WebForm3" %>
...
<body>
 ...
 <tbody>
     <% var yesData = Lab3.ResponseRepository.GetRepository().GetAllResponses()
