<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    Inherits="ASP.Zachet.TEST.ShowStudentONE" 
...
<asp:Content ID="MainContent" 
    ...
    <div>
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDataSource1">
        ...
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="ASP.Zachet.TEST.SampleContext" EntityTypeName="" Where="AverageMark>8" Select="new (Name, Surname, Group, AverageMark)" TableName="Students"> </asp:LinqDataSource>
