<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="Lab4.WebForm3" %>
...
<body>
 ...
 <tbody>
     <% var yesData = Lab1.EX._1._2.ResponseRepository.GetRepository().GetAllResponses()
